...
const consumerProfile = ('/profile', asyncHandler(async(req, res) => {
...
module.exports = {consumerRegister, consumerLogin, consumerProfile, viewRests, viewRest, viewOrders, viewOrder};